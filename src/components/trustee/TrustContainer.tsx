    ...
    <div className="container relative bg-[#1D2E1F] px-[50px] w-full py-[50px] h-[500px] flex items-center justify-between">
      ...
      <div className="text-container relative z-10  fade-in-element">
        <p className="paragraph text-[#A6A097] font-[400] text-[16px] mb-6 leading-relaxed">
          ...
          solutions to simplify exporting for businesses, helping them thrive in
          the global market. Our state-of-the-art processing and packaging
          center ensures top quality products reach international destinations.
          Our mission is to be a trusted partner for navigating the complexities
          of global agricultural trade, ultimately contributing to Nigeria's
          economic growth and establishing the country as a major player in the
          global market.
        </p>
